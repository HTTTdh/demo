...
void LinkedList::docfile()
{
    ThiSinh ts;
    ifstream inputFile;
    inputFile.open("C:/Users/DELL/Documents/pblcu/dsthisinh.txt", ios::in);
    if (inputFile.is_open())
    {
        ...
        while (getline(inputFile, line))
        {
            ...
            for( int i = 1; i <= ts.getso_nv(); i++){
                pos = line.find(",");
                ts.nguyenvong[i] = line.substr(0,pos);
                line.erase(0, pos + 1);
            }
...
void LinkedList::ghifile(){
    ofstream outputFile;
    outputFile.open("C:/Users/DELL/Documents/pblcu/dsthisinh.txt", ios::out);
    if (outputFile.is_open())
    {
        ...
        while (current != NULL)
        {
            ...
            for( int i = 1; i<= current->data.getso_nv() ; i ++){
                outputFile << "," << current->data.nguyenvong[i];
            }
            outputFile << endl;
